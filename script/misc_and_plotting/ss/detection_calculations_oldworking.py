...
class detection_calculations(object): 
	...
	open(self.path + 'detection_data.txt', 'w').close()
        ...
        try:
            ...
            rospy.Subscriber('/jackal/ground_truth/odometry', Odometry, self.targe_callback, tcp_nodelay = True)
    ...
    def detection_callback(self, data):
	    ...
	    f.write("%s, %s, %s, %s, %s, %s, %s, %s, %s\n" % (mu, p, pfa, np.exp(self.pmd_exponent), tau, vi_integration, count_multiplication, LR, self.detection_threshold))
