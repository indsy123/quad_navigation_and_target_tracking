...
#from realsense_pointcloud_analysis.msg import publish_bounding_boxes, box_coordinates
...
class quadrotor_detection_class(object):
    def __init__(self, ckpt_path, labels_path, n_classes): 
        ...
        open(self.logpath+'inference_confidence_lab.txt', 'w').close()
        ...
        #self.publish_boxes = rospy.Publisher('/detection_boxes', publish_bounding_boxes, queue_size = 30, latch=True)
        
        rospy.Subscriber('/udrone1/d435/color/image_raw', Image, self.detect_quad, buff_size = 2**24)
...
if __name__ == '__main__':
    package_path = '/home/pelican/catkin_ws/src/quad_navigation_and_target_tracking/'
    PATH_TO_CKPT = package_path + 'dnn/trt_graph_ssd_mobilenet.pb'
    #PATH_TO_CKPT = package_path + 'dnn/fine_tuned_model/ssd_mobilenet_v2_groundrobot_trt.pb'
    PATH_TO_LABELS = package_path + 'dnn/pascal_label_map.pbtxt'
    NUM_CLASSES = 1 
    
    quadrotor_detection_class(PATH_TO_CKPT, PATH_TO_LABELS, NUM_CLASSES)
