...
class planner
{
  ...
  private:     
    ...
    ros::Subscriber odom_sub, pc_sub, bat_sub;
    ros::Publisher cmd_pub, pc_pub, ensemble_pub, best_traj_pub, selected_traj_pub, pose_pub;

    string mode, odom_topic, pc_topic, cmd_topic, pcFrame, camBaseframe, px4_controller_type, posecmd_topic, run_number, battery_topic;
